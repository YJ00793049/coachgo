    ...
    <div style={{ perspective: 800 }}>
      ...
      >
        ...
        <div
          ...
          style={{
            background: selected ? 'rgba(79,142,247,0.15)' : 'rgba(255,255,255,0.02)',
            border: selected ? '2px solid transparent' : '2px solid rgba(255,255,255,0.08)',
            color: selected ? '#4F8EF7' : (secondary ? 'rgba(255,255,255,0.4)' : 'rgba(255,255,255,0.5)'),
          }}
        >
          {spec}
        </div>
  ...
  return (
    <PageTransition>
      <div className="min-h-screen" style={{ background: '#0A0F1E' }}>
        ...
        {successMsg && (
          <div className="fixed top-6 left-1/2 -translate-x-1/2 z-50 px-6 py-3 rounded-2xl font-bold text-white text-sm shadow-2xl"
            style={{ background: 'linear-gradient(135deg, #4F8EF7, #2563EB)', boxShadow: '0 8px 30px rgba(79,142,247,0.4)' }}>
            {successMsg}
          </div>
        )}
        ...
        <div className="py-12 pt-28" style={{ background: 'rgba(79,142,247,0.05)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          <div className="max-w-2xl mx-auto px-4 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#4F8EF7' }}>Coach Setup</p>
              <h1 className="text-3xl font-bold text-white mb-2">Build your CoachGo profile</h1>
              <p style={{ color: 'rgba(255,255,255,0.4)' }}>This takes less than 2 minutes. You can update everything later.</p>
            </motion.div>
                  ...
                  <div key={i} className="relative flex items-center justify-center" style={{ width: active ? 32 : 12, height: 12 }}>
                    {active ? (
                      <motion.div
                        ...
                        transition={{ ...SPRING }}
                        style={{ background: '#4F8EF7', boxShadow: '0 0 12px rgba(79,142,247,0.6)', height: 8, top: 2, willChange: 'transform' }}
                      />
                    ) : completed ? (
                      <div className="rounded-full flex items-center justify-center" style={{ width: 12, height: 12, background: 'rgba(79,142,247,0.3)' }}>
                        <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth={3} strokeLinecap="round" strokeLinejoin="round" style={{ width: 7, height: 7 }}>
            ...
            <p className="text-xs mt-3 font-bold uppercase tracking-widest" style={{ color: 'rgba(255,255,255,0.25)' }}>
        ...
        <div className="max-w-2xl mx-auto px-4 py-12" style={{ perspective: 1200 }}>
          <div className="rounded-3xl p-8 md:p-12" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', transformStyle: 'preserve-3d' }}>
              ...
              {step === 1 && (
                <motion.div key="s1" initial={stepEnter} animate={stepShow} exit={stepExit} style={{ transformStyle: 'preserve-3d', willChange: 'transform' }}>
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white">What's your specialty?</h2>
                      <p className="text-sm" style={{ color: 'rgba(255,255,255,0.4)' }}>Choose your primary coaching focus.</p>
                    </div>
                  </div>
                  ...
                  <div className="mb-8">
                    <label className="block text-xs font-bold uppercase tracking-widest mb-4" style={{ color: 'rgba(255,255,255,0.4)' }}>
                      Secondary Specialty <span style={{ color: 'rgba(255,255,255,0.2)' }}>(optional)</span>
                    </label>
                ...
                <motion.div key="s2" initial={stepEnter} animate={stepShow} exit={stepExit} style={{ transformStyle: 'preserve-3d', willChange: 'transform' }}>
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                      ...
                      <p className="text-sm" style={{ color: 'rgba(255,255,255,0.4)' }}>Tell players about your experience.</p>
                    </div>
                  </div>

                  {/* Photo Upload */}
                  <div className="mb-8 p-6 rounded-2xl" style={{ background: 'rgba(79,142,247,0.04)', border: '1px solid rgba(79,142,247,0.12)' }}>
                    <p className="text-xs font-bold uppercase tracking-widest mb-1" style={{ color: '#4F8EF7' }}>Profile Photo <span style={{ color: 'rgba(255,255,255,0.25)' }}>(optional)</span></p>
                    <p className="text-xs font-semibold mb-5" style={{ color: 'rgba(255,255,255,0.5)' }}>Add a professional photo — coaches with photos get 3x more bookings</p>
                    <div className="flex items-center gap-6">
                      ...
                      >
                        <div className="w-full h-full rounded-full overflow-hidden flex flex-col items-center justify-center"
                          style={{
                            background: photoPreview ? 'transparent' : 'rgba(79,142,247,0.08)',
                            border: `2px dashed ${photoPreview ? 'rgba(79,142,247,0.5)' : 'rgba(79,142,247,0.3)'}`,
                          }}>
                          {photoPreview ? (
                            <img src={photoPreview} alt="Preview" className="w-full h-full object-cover" />
                          ) : (
                            <div className="flex flex-col items-center gap-2">
                              <Camera size={32} style={{ color: 'rgba(79,142,247,0.5)' }} />
                              <span className="text-[10px] font-bold uppercase tracking-widest" style={{ color: 'rgba(79,142,247,0.5)' }}>Upload</span>
                            </div>
                          )}
                        </div>
                      ...
                      <div className="flex-1">
                        ...
                        {isUploading && (
                          <div className="mb-3">
                            <div className="flex justify-between mb-1">
                              <span className="text-[10px] font-bold uppercase tracking-widest" style={{ color: 'rgba(255,255,255,0.35)' }}>Uploading...</span>
                              <span className="text-[10px] font-bold" style={{ color: '#4F8EF7' }}>{uploadProgress}%</span>
                            </div>
                        ...
                        {!isUploading && photoUploadedUrl && (
                          <p className="text-xs mb-3 font-semibold" style={{ color: '#22c55e' }}>
                        ...
                        <button
                          type="button"
                          onClick={() => fileInputRef.current?.click()}
                          className="text-xs font-bold uppercase tracking-widest px-4 py-2.5 rounded-xl transition-all hover:bg-blue-500/10"
                  ...
                  <div className="mb-8">
                    <label className="block text-xs font-bold uppercase tracking-widest mb-3" style={{ color: 'rgba(255,255,255,0.4)' }}>Bio</label>
                    <textarea rows={6}
                      ...
                      className="w-full rounded-xl p-4 text-sm resize-none text-white focus:outline-none"
                      style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.08)' }} />
                    <div className="flex justify-between mt-1">
                      <p className="text-xs" style={{ color: 'rgba(255,255,255,0.2)' }}>Each line auto-formats as a bullet point. Press Enter for a new one.</p>
                      <p className="text-xs" style={{ color: profile.bio.length > 800 ? '#F59E0B' : 'rgba(255,255,255,0.2)' }}>{profile.bio.length}/1000</p>
                    </div>
                  </div>

                  {/* Intro Video — Required */}
                  <div className="mb-8 p-6 rounded-2xl" style={{ background: 'rgba(124,58,237,0.04)', border: '1px solid rgba(124,58,237,0.15)' }}>
                    <div className="flex items-center gap-2 mb-1">
                      <p className="text-xs font-bold uppercase tracking-widest" style={{ color: '#7C3AED' }}>Intro Video</p>
                    ...
                    <p className="text-xs font-semibold mb-5" style={{ color: 'rgba(255,255,255,0.5)' }}>
                    ...
                    {!videoPreviewUrl && !videoUploadedUrl && !isVideoUploading && (
                      <div className="grid grid-cols-2 gap-3">
                        <button type="button" onClick={() => videoRecordRef.current?.click()}
                          className="flex flex-col items-center justify-center gap-2 py-8 rounded-2xl font-bold text-sm transition-all hover:bg-purple-500/10"
                          style={{ background: 'rgba(124,58,237,0.06)', border: '1px solid rgba(124,58,237,0.2)', color: '#7C3AED' }}>
                          <Video size={28} />
                          Record Now
                          <span className="text-[10px] font-normal" style={{ color: 'rgba(255,255,255,0.3)' }}>Uses your camera</span>
                        </button>
                        <button type="button" onClick={() => videoUploadRef.current?.click()}
                          className="flex flex-col items-center justify-center gap-2 py-8 rounded-2xl font-bold text-sm transition-all hover:bg-blue-500/10"
                          style={{ background: 'rgba(79,142,247,0.06)', border: '1px solid rgba(79,142,247,0.2)', color: '#4F8EF7' }}>
                          <Upload size={28} />
                          Upload Video
                          <span className="text-[10px] font-normal" style={{ color: 'rgba(255,255,255,0.3)' }}>MP4, MOV, WebM</span>
                        </button>
                      </div>
                    )}
                    ...
                    {isVideoUploading && (
                      <div>
                        <div className="flex justify-between mb-1.5">
                          <span className="text-[10px] font-bold uppercase tracking-widest" style={{ color: 'rgba(255,255,255,0.35)' }}>Uploading video...</span>
                          <span className="text-[10px] font-bold" style={{ color: '#7C3AED' }}>{videoUploadProgress}%</span>
                        </div>
                        <div className="w-full h-2 rounded-full overflow-hidden" style={{ background: 'rgba(255,255,255,0.06)' }}>
                          <motion.div
                            ...
                            transition={{ ease: 'linear', duration: 0.2 }}
                            style={{ background: 'linear-gradient(90deg, #7C3AED, #4F8EF7)' }}
                          />
                        </div>
                        {videoFileName && <p className="text-[10px] mt-1.5" style={{ color: 'rgba(255,255,255,0.25)' }}>{videoFileName}</p>}
                      </div>
                    )}
                      ...
                      <div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            ...
                            {videoFileName && <span className="text-[10px]" style={{ color: 'rgba(255,255,255,0.25)' }}>{videoFileName}</span>}
                          </div>
                          <button type="button"
                            onClick={() => { setVideoPreviewUrl(null); setVideoUploadedUrl(null); setVideoFileName(''); }}
                            className="text-[10px] font-bold uppercase tracking-widest px-3 py-1.5 rounded-xl transition-all hover:bg-red-500/10"
                  ...
                  <div className="mb-8">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-[10px]" style={{ color: 'rgba(255,255,255,0.2)' }}>(optional)</span>
                    </div>
                    <p className="text-xs mb-3" style={{ color: 'rgba(255,255,255,0.25)' }}>Teams, colleges, or leagues you've played or coached for.</p>
                      ...
                      <div className="flex flex-wrap gap-2 mb-3">
                        {profile.affiliations.map((aff, idx) => (
                          <div key={idx} className="flex items-center gap-2 px-3 py-1.5 rounded-xl text-sm font-bold"
                            style={{ background: 'rgba(79,142,247,0.12)', border: '1px solid rgba(79,142,247,0.25)', color: '#93C5FD' }}>
                            {aff.logoUrl && (
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full rounded-xl p-4 text-sm text-white focus:outline-none"
                        style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.08)' }}
                      />
                      {showAffiliationDropdown && affiliationSearch.length > 0 && (
                        <div className="absolute top-full left-0 right-0 mt-1 rounded-xl overflow-hidden z-20 shadow-2xl max-h-52 overflow-y-auto"
                            ...
                            .map(opt => (
                              <button key={opt.name} type="button"
                                ...
                                {opt.logoUrl
                                  ...
                                  : <div className="w-5 h-5 rounded-full shrink-0 flex items-center justify-center text-[8px] font-bold" style={{ background: 'rgba(79,142,247,0.2)', color: '#4F8EF7' }}>{opt.name[0]}</div>
                                }
                                <div>
                                  <span className="font-medium">{opt.name}</span>
                                  <span className="ml-2 text-[10px] uppercase tracking-widest" style={{ color: 'rgba(255,255,255,0.3)' }}>{opt.category}</span>
                                </div>
                              </button>
                            ))}
                          {AFFILIATION_OPTIONS.filter(a =>
                            ...
                            <div className="px-4 py-3 text-sm" style={{ color: 'rgba(255,255,255,0.35)' }}>No matches found</div>
                          )}
                        </div>
                      )}
                    </div>
              ...
              {step === 3 && (
                <motion.div key="s3" initial={stepEnter} animate={stepShow} exit={stepExit} style={{ transformStyle: 'preserve-3d', willChange: 'transform' }}>
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white">Your skill tags</h2>
                      <p className="text-sm" style={{ color: 'rgba(255,255,255,0.4)' }}>Pick up to 6 that best describe what you teach.</p>
                    </div>
                  </div>
                    ...
                    {(skillSuggestions[profile.specialty] || []).map(skill => {
                      ...
                      return (
                        <motion.button
                          ...
                          style={{
                            background: isSelected ? 'rgba(79,142,247,0.2)' : 'rgba(255,255,255,0.04)',
                            border: `1px solid ${isSelected ? '#4F8EF7' : 'rgba(255,255,255,0.08)'}`,
                            color: isSelected ? '#4F8EF7' : 'rgba(255,255,255,0.5)',
                  ...
                  {showCustomSkillInput ? (
                    <div className="flex gap-2 mb-6">
                      <input
                        ...
                        autoFocus
                        className="flex-1 rounded-xl p-3 text-sm text-white focus:outline-none"
              ...
              {step === 4 && (
                <motion.div key="s4" initial={stepEnter} animate={stepShow} exit={stepExit} style={{ transformStyle: 'preserve-3d', willChange: 'transform' }}>
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white">Pricing & Experience</h2>
                      <p className="text-sm" style={{ color: 'rgba(255,255,255,0.4)' }}>Set your rate and experience level.</p>
                    </div>
                  </div>
                  ...
                  <div className="mb-6">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-[10px]" style={{ color: 'rgba(255,255,255,0.25)' }}>Add all types you offer</span>
                    </div>
                      ...
                      {profile.sessionTypes.map((st, idx) => (
                        <div key={idx} className="flex gap-3 items-center">
                          ...
                          <div className="flex items-center rounded-xl overflow-hidden shrink-0"
                            style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.08)' }}>
                            <span className="pl-3 text-sm font-bold" style={{ color: 'rgba(255,255,255,0.35)' }}>$</span>
                            <input
                              type="number"
                              placeholder="100"
                              value={st.price}
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest px-4 py-2.5 rounded-xl transition-all hover:bg-blue-500/10"
                      style={{ color: '#4F8EF7', border: '1px solid rgba(79,142,247,0.2)' }}>
                  ...
                  {/* Years of Experience */}
                  <div className="mb-6">
                    <label className="block text-xs font-bold uppercase tracking-widest mb-3" style={{ color: 'rgba(255,255,255,0.4)' }}>Years of Experience</label>
                  ...
                  <div className="mb-8">
                    <div className="flex items-center gap-2 mb-1">
                      <label className="text-xs font-bold uppercase tracking-widest" style={{ color: 'rgba(255,255,255,0.4)' }}>
                        Venmo Handle <span style={{ color: '#ef4444' }}>*</span>
                      </label>
                      <span className="text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 rounded-full" style={{ background: 'rgba(239,68,68,0.1)', color: '#ef4444', border: '1px solid rgba(239,68,68,0.2)' }}>Required</span>
                    </div>
                    <p className="text-[10px] mb-3" style={{ color: 'rgba(255,255,255,0.25)' }}>Players will pay you through Venmo after confirmation.</p>
                    <div className="flex items-center gap-3 rounded-xl overflow-hidden"
                      style={{ background: 'rgba(255,255,255,0.05)', border: `1px solid ${!profile.venmoHandle.trim() ? 'rgba(239,68,68,0.25)' : 'rgba(255,255,255,0.08)'}` }}>
                      <span className="pl-4 font-bold text-sm shrink-0" style={{ color: 'rgba(255,255,255,0.35)' }}>@</span>
                      <input
                        type="text"
              ...
              {step === 5 && (
                <motion.div key="s5" initial={stepEnter} animate={stepShow} exit={stepExit} style={{ transformStyle: 'preserve-3d', willChange: 'transform' }}>
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white">Where do you coach?</h2>
                      <p className="text-sm" style={{ color: 'rgba(255,255,255,0.4)' }}>Players will see this and get directions.</p>
                    </div>
                  </div>

                  <div className="space-y-4 mb-8">
                    <div>
                      <label className="block text-xs font-bold uppercase tracking-widest mb-3" style={{ color: 'rgba(255,255,255,0.4)' }}>Training Facility / Address</label>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="block text-xs font-bold uppercase tracking-widest mb-3" style={{ color: 'rgba(255,255,255,0.4)' }}>City</label>
                      ...
                      <div>
                        <label className="block text-xs font-bold uppercase tracking-widest mb-3" style={{ color: 'rgba(255,255,255,0.4)' }}>State</label>
                  ...
                  {/* Final summary */}
                  <div className="rounded-2xl p-6 mb-8" style={{ background: 'rgba(79,142,247,0.06)', border: '1px solid rgba(79,142,247,0.12)' }}>
                    <h4 className="text-xs font-bold uppercase tracking-widest mb-4" style={{ color: 'rgba(255,255,255,0.3)' }}>Profile Summary</h4>
                    <div className="space-y-2 text-sm">
                      {[
                        ...
                        <div key={item.label} className="flex justify-between gap-4">
                          ...
                          <span className="font-bold text-white capitalize text-right">{item.value}</span>
                        </div>
                      ))}
                    </div>
                  </div>
