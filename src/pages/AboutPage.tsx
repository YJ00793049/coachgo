  ...
  return (
    <PageTransition>
      <div className="min-h-screen" style={{ background: '#080B14' }}>
        ...
        {/* Hero */}
        <section className="py-32 px-4" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          <div className="max-w-[720px] mx-auto text-center">
            ...
            <motion.h1
              ...
              className="font-display text-6xl md:text-7xl text-white leading-none mb-16"
            >
              WHY WE<br />
              <span style={{ WebkitTextStroke: '1px rgba(255,255,255,0.25)', color: 'transparent' }}>BUILT THIS</span>
            </motion.h1>
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              <p style={{ color: 'rgba(255,255,255,0.55)' }}>
                ...
                <span className="text-white font-semibold">finding a great coach felt impossible.</span>{' '}
              ...
              <p style={{ color: 'rgba(255,255,255,0.55)' }}>
                ...
                <span className="text-white font-semibold">it's a universal baseball problem.</span>{' '}
              ...
              <p style={{ color: 'rgba(255,255,255,0.55)' }}>
                <span className="text-white font-semibold">CoachGo is the platform that should have always existed.</span>{' '}
        ...
        {/* Values */}
        <section className="py-32" style={{ background: 'rgba(255,255,255,0.01)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <h2 className="font-display text-5xl md:text-6xl text-white leading-none">
                OUR<br />
                <span style={{ WebkitTextStroke: '1px rgba(255,255,255,0.25)', color: 'transparent' }}>VALUES</span>
              </h2>
            </motion.div>
              ...
              {VALUES.map((value, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <p className="font-medium mb-3" style={{ color: 'rgba(255,255,255,0.7)' }}>{value.desc}</p>
                    <p className="text-sm leading-relaxed" style={{ color: 'rgba(255,255,255,0.4)' }}>{value.detail}</p>
                  </motion.div>
                </motion.div>
              ))}
            </div>
            ...
            >
              ...
              <div className="shrink-0 relative">
                ...
                <Avatar className="w-48 h-48 md:w-[200px] md:h-[200px] rounded-3xl relative" style={{ zIndex: 1 }}>
                  ...
                  />
                  <AvatarFallback
                    className="rounded-3xl text-5xl font-display font-bold text-white"
                    style={{
                      background: 'linear-gradient(135deg, #4F8EF7 0%, #7C3AED 50%, #2563EB 100%)',
                      boxShadow: '0 0 40px rgba(79,142,247,0.4), inset 0 1px 0 rgba(255,255,255,0.2)',
                    }}
                  >
                    YJ
                  </AvatarFallback>
              ...
              {/* Content */}
              <div>
                <p className="text-xs font-bold uppercase tracking-[0.2em] mb-3" style={{ color: '#4F8EF7' }}>Meet the Founder</p>
                <h2 className="font-display text-4xl text-white mb-1">Yuvraj Jindal</h2>
                <p className="text-sm font-medium mb-8 uppercase tracking-widest" style={{ color: 'rgba(255,255,255,0.3)' }}>
                  Founder · Del Norte HS Varsity Baseball
                </p>

                <div className="space-y-5 text-base leading-relaxed">
                  <p style={{ color: 'rgba(255,255,255,0.55)', fontSize: '1.15rem', lineHeight: '1.8' }}>
                    <span className="text-white font-semibold">"I've been on the field since I was 7 years old.</span>{' '}
                  ...
                  <p style={{ color: 'rgba(255,255,255,0.55)', fontSize: '1.15rem', lineHeight: '1.8' }}>
                    ...
                    <span className="text-white font-semibold">I spent years hopping from coach to coach,
                    never having one place to search, compare, and commit.</span>"
                  </p>
                  <p style={{ color: 'rgba(255,255,255,0.55)', fontSize: '1.15rem', lineHeight: '1.8' }}>
                    "<span className="text-white font-semibold">I got tired of waiting for someone else to fix it.</span>{' '}
        ...
        {/* Stats */}
        <section className="py-20" style={{ background: 'rgba(79,142,247,0.04)', borderTop: '1px solid rgba(255,255,255,0.06)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          <div className="max-w-4xl mx-auto px-4">
            <div className="grid grid-cols-3 gap-8 text-center">
              {[
                ...
                >
                  <p className="font-display text-5xl text-white mb-2">{stat.value}</p>
                  <p className="text-xs font-bold uppercase tracking-widest" style={{ color: 'rgba(255,255,255,0.3)' }}>{stat.label}</p>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <section className="py-24 text-center">
          <div className="max-w-3xl mx-auto px-4">
            <motion.div
              ...
              transition={{ ...SPRING }}
            >
              <h2 className="font-display text-5xl text-white mb-8 gradient-headline">READY TO FIND YOUR EDGE?</h2>
